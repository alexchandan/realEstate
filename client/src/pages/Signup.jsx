    ...
    return (
        <div className='p-3 max-w-lg mx-auto'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                <input type="text" className="border p-3 rounded-lg focus:outline-none" id='username' name='username' onChange={handleChange} placeholder='username' />
                <input type="email" className='border p-3 rounded-lg focus:outline-none' id='email' name='email' onChange={handleChange} placeholder='email' />
